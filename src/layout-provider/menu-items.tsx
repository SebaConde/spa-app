      ...
      <SheetContent>
        ...
        <div className="flex flex-col gap-7 mt-20 px-7">
          {menuItemsToRender.map((menuItem)=>(
            <div key={menuItem.route} className={`flex gap-5 items-center p-2 rounded-md cursor-pointer ${pathName===menuItem.route ? 'bg-gray-100 border border-gray-500': 'text-gray-500'}`}>
              {menuItem.icon}
